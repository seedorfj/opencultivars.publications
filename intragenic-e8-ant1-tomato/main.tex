...
% Intended for compilation on Overleaf. 
...
\pagestyle{fancy}
\fancyhf{}
\rhead{Defensive Publication --- March 30, 2026}
...
\begin{longtable}{p{2cm} p{2cm} p{2cm} p{2cm} p{5.5cm}}
\toprule
...
\addlinespace
Strawberry & \textit{F.~$\times$~anan-assa} & FaMYB10 & FaEXP2 & FaMYB10 activates anthocyanin production \citep{MedinaPuche2014}. FaEXP2 is fruit-expressed. Pairing untested. \\
\addlinespace
